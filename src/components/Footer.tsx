      ...
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="mt-4 text-gray-400">
              ...
              empresas a alcanzar su máximo potencial.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center">
                ...
                <a
                  href="mailto:lvilladagonzalez0@gmail.com"
                  className="text-gray-400 hover:text-white transition-colors"
                >
                  lvilladagonzalez0@gmail.com
                </a>
              </li>
              <li className="flex items-center">
                <svg
        ...
        <div className="border-t border-gray-800 mt-10 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm order-2 md:order-1 mt-4 md:mt-0">
            &copy; {new Date().getFullYear()} ConsultaPro. Todos los derechos
            reservados.
          </p>
