    ...
    <section id="contact" className="py-16 bg-gray-50">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Contáctenos</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Estamos listos para discutir cómo podemos ayudar a su organización a alcanzar nuevos niveles de eficiencia y éxito.
          </p>
        </div>
          ...
          <div className="flex flex-col md:flex-row">
            <div className="md:w-2/5 bg-blue-900 text-white p-8 md:p-12">
              ...
              <p className="mb-8 text-blue-200">
                Complete el formulario o contáctenos directamente utilizando la información a continuación.
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="font-medium">info@consultapro.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="font-medium">Av. Reforma 123, Col. Juárez</p>
                    <p className="font-medium">Ciudad de México, CP 06600</p>
                  </div>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="strategic-planning">Planificación Estratégica</option>
                    <option value="project-management">Gestión de Proyectos</option>
                    <option value="org-transformation">Transformación Organizacional</option>
                    <option value="process-optimization">Optimización de Procesos</option>
                    <option value="team-development">Desarrollo de Equipos</option>
                    <option value="tech-consulting">Consultoría Tecnológica</option>
